...
- [x] `dash_35` (legacy) powers on reliably
...
- [x] `dash_35` (legacy) serial port appears on the host computer
- [x] `dash_35` (legacy) can open a serial monitor at 115200 baud

## `dash_35` (legacy) Checks
...
Implementation should begin only after the `dash_35` (legacy) checks above are confirmed.

## USB Port Assignments

| Board           | USB Port                        |
|-----------------|---------------------------------|
| `dash_35` (legacy)       | `/dev/cu.usbmodem5AAF1861091`   |
